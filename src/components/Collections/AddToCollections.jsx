...
//     try {
//       const response = await api.post("/collection/add-recipe", {
//         recipeId,
//         collectionId, // assuming backend expects a single `collectionId`
//       });
...
//   if (isPageLoading) {
//     return (
//       <div className="h-[400px] z-50 overflow-scroll bg-gray-700 text-white p-4">
//         Loading collections...
//       </div>
//     );
//   }
...
//   return (
//     <div ref={AddToCollectionsRef} className="h-[400px] w-[100vw] fixed bottom-0 z-50 overflow-scroll bg-yellow-400 text-black p-4 space-y-3">
