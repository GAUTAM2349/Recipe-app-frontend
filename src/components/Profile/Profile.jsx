...
//     if( id != 0) fetchOtherProfilesData(id);
    
//   },[]);

//   const fetchOtherProfilesData = async (id) => {

//     try{

//       const followersResponse = await api.get("/follow/followers");
//       setFollowers(followersResponse.data);

//       const followingResponse = await api.get("/follow/following");
